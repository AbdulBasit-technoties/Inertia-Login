...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly;">
  <center style="width: 100%;">
    <div
      style="max-width: 400px; margin: 0 auto; border: 1px solid #80808047; padding: 40px 30px; box-sizing: border-box; border-radius: 10px; margin-top: 50px;"
    ...
    : public_path('image/no-image.webp') }}" alt="Logo">
        ...
        <tr>
          <td>
            <div class="main-title-box">
              <h2>Your Invoice #{{ $invoice->id }}</h2>
              <p>
                Dear <strong>
                  {{ $invoice->model->first_name ?? $invoice->model->full_name }}
                </strong>,
              </p>
        ...
        <tr>
          <td>
            <div class="main-btn">
              <a href="{{ $payUrl }}" target="_blank">Pay Now</a>
            </div>
